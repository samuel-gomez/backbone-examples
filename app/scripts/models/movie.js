    ...
    * Un nouvel Objet Theater.Movies est créé 
    * On crée une instance de vue Movies et l'on lui passe en paramètre l'instance de collection Movies
    * La fonction fetch est asynchrone, elle lance une requête pour exécuter le fichier JSON
    */
    ...
    */
    ...
    /*
    * Bouton d'ajout de film pour les tests
    */
